        ...
        <Container className='container-general help'> 
            ...
            <div className='faq-section'>
                <section>
                    ...
                    <p>
                        Todos los productos que publicamos están en stock. En caso de agotarse alguna torta o tarta, esa sección, y no podrás seleccionarla. Haciendo click en el botón Consultar disponibilidad vas a poder realizar consulta de disponibilidad de stock y te enviaremos un email cuando haya stock nuevamente.
                    </p>
